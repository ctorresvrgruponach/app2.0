...
final calcularPrestamo =
  ...
  final montoinput = ref.watch(montoinputControllerProvider);
  final plazos = ref.watch(plazosControllerProvider);
  ...
  final dynamic calculo = await fetchPostData(
      ...
      baseUrl,
      calculaPrestamo,
      postDatas); // Manejar el caso en el que dataAdelantos no es un mapa válido o cuando "success" no está presente.
