            ...
            future: ref.watch(solicita_prestamo.future),
             builder: (context, snapshot){
              ...
              if (snapshot.hasData && snapshot.data!['empleado'] != null){
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return CustomAlertDialog(
                              message: 'Tu Prestamo Debe Ser Menor o Igual a \$$monto_maximo',
                    ...
                    void ValidaPlazos() {
                      ...
                      if (amount != null && amount > plazos_restantes) {
                        showDialog(
                          ...
                          builder: (context) {
                            return CustomAlertDialog(
                              message: 'Los plazos no pueden ser mayor a $plazos_restantes.',
                              title: 'Error...',
                              icon: Icons.error_outline_outlined,
                              color: Colors.amber
                            );
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              ElevatedButton(
                                  onPressed: btncalculaprestamo ? null :() {
                                    ...
                                    if(_formKey.currentState!.validate()){
                                      ...
                                      fetchData().then((response) {
                                        print('AQUI PINTAMOS EVALES Y TODO EL ROLLO');
                                        final montoingresado = _montoinput.text;
                                        final montofinal = double.parse(montoingresado);
                                        final monto_x_aval = snapshot.data!['monto_x_aval'];
                                        double resultadoDivision = double.parse(montoingresado) / monto_x_aval;
                                        int resultadoRedondeado = resultadoDivision.ceil();
                                        final montoIngresado = _montoinput.text;
                                        final  Comision = response['resumen']['comision'];
                                          if (response['estatus'] == 200) {
                                              setState(() {
                                                showForm      = true;
                                                DATA          = response;
                                  ...
                                  style: ButtonStyle(
                                    backgroundColor: MaterialStateProperty.all<Color>(btncalculaprestamo ? Color.fromARGB(255, 23, 23, 23) :const Color.fromARGB(255, 5, 50, 91)), // Color de fondo azul
                                  ),
                                ...
                                Visibility(
                                  ...
                                  child: Column(
                                    children: [
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                ...
                                                initialValue: DATA['abono'].toString(),
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child:  Avales(avales,avalesn,cnatidadfinal),
                                      ),
                                    ],
                                  ),
                                )  ,
                  ...
                  return Container(child: Center(child: const Text('Error intentalo mas tarde.')));
  ...
  Widget Avales(avales, navales,cnatidadfinal) {
   ...
   return Center(
        child: Container(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [Text('Selecciona a tus avales', style: TextStyle(fontWeight: FontWeight.w900),),
                                ...
                                showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return const CustomAlertDialog(
                                      message: ' Este aval ya a sido seleccionado por favor elige otro',
                                      title: 'Atencion',
                                      icon: Icons.error_outline,
                                      color: Colors.amber
                                    );
                ...
                ElevatedButton(
                  onPressed: btnsolicitaPrestamo ? null : () async {
                    ...
                    if(totalAmount == cnatidadfinal){
                      ...
                      SharedPreferencesHelper.setdatos('monto_pago' ,'${DATA['abono']}'); //monto pago
                    ...
                    SizedBox(height: 20);
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return const CustomAlertDialog(
                            message: ' Verifica el monto ingresado por aval',
                            title: 'Ups...',
                            icon: Icons.error_outline,
                            color: Colors.amber
                          );
                  ...
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all<Color>(btnsolicitaPrestamo ? Color.fromARGB(255, 23, 23, 23) :const Color.fromARGB(255, 5, 50, 91)), // Color de fondo azul
                   // Color de fondo azul
                  ),
