            ...
            FutureBuilder<Map<String, dynamic>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData &&
                  ...
                  direccionExtt.text = operaciones['direccion_ext'].toString();
                  direccionIntt.text = operaciones['direccion_int'].toString();
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  children: [
                                    textot1(context, 'Folio de consulta Buro'),
                                    SizedBox(
                                      width: displayWidth(context) * 0.45,
                                      height: 60,
                                      child: TextFormField(
