...
class SolicitudesState extends ConsumerState<SolicitudesScreen> {
  @override
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Consumer(builder: (context, watch, child) {
                        final postMissolicitudesProvider =
                            ref.watch(postMissolicitudesProviders);
                        return postMissolicitudesProvider.when(
                          data: (data) {
                            if (data["success"] != null && data["success"]) {
                              // Procesar y mostrar datos en DataTable
                              // print(data['servicios'][0]["nombre_servicio"]);
                              List<Widget> buildServiciosItemss(
                                  BuildContext context,
                                  List<dynamic> servicios) {
                                List<Widget> itemssolicitudes = [];
