        ...
        body: Column(
          children: <Widget> [
            ...
            child: FutureBuilder<Map<String, dynamic>>(
                future: ref.watch(notificacionesEmpleado.future),
                builder: (context, snapshot) {
                  if (snapshot.hasData &&snapshot.data!['notificaciones'] != null) {
                    int  notificaciones = snapshot.data!['notificaciones'];
                    // print('notificaciones pendientes $notificaciones');
